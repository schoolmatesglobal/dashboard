...
import { colors, removeDuplicates, removeDuplicates2 } from "../../../constant";
import { useAuthDetails } from "../../../../../../stores/authDetails";
import { useGradePoint } from "../../../../../../hooks/useGradePoint";
import Heading from "../ResultHeading";
import Block from "../ResultBlock";
          ...
          >
            ...
            <div
              style={{
                ...
                backgroundColor: `${colors?.lightGreen}`, // bg-lime-200/20
              }}
            >
              <Heading
                text={`${locationState?.creds?.session} ACADEMIC SESSION`}
              />
            </div>
            ...
            >
              <div style={{ gridColumn: "span 3 / span 3" }}>
                <Block
                  ...
                  className={{ gridColumn: "span 3 / span 3" }} // Converted col-span-3
                  titleWrap={false}
                  valueWrap={true}
                />
              </div>
              <div style={{ gridColumn: "span 2 / span 2" }}>
                <Block
                  ...
                  className={{ gridColumn: "span 3 / span 3" }} // Converted col-span-2
                  titleWrap={false}
                  valueWrap={true}
                />
              </div>
              <div style={{ gridColumn: "span 2 / span 2" }}>
                <Block
                  title='TERM'
                  value={locationState?.creds?.term}
                  className={{ gridColumn: "span 2 / span 2" }} // Converted col-span-1
                  titleWrap={false}
                  valueWrap={true}
                />
              </div>
              <div style={{ gridColumn: "span 3 / span 3" }}>
                <Block
                  title='CLASS'
                  value={additionalCreds?.class_name}
                  // value={tagValues?.session?.label}
                  className={{ gridColumn: "span 2 / span 2" }} // Converted col-span-1
                  titleWrap={false}
                  valueWrap={true}
                />
