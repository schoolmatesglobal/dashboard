  ...
  return (
    <>
      <div className={styles.create}>
        ...
        {!allLoading && (
          <div className='d-flex  mt-3 justify-content-center align-items-center gap-3 bg-info bg-opacity-10 py-4 px-4'>
            <p className='fs-3 fw-bold '>{state?.topic}</p>
        ...
        {!allLoading && question_type === "theory" && theoryQ?.length === 0 && (
          <div className={styles.placeholder_container}>
            ...
            <p className='fs-1 fw-bold mt-3'>Create theory Exercise</p>
          </div>
        )}
        {!allLoading &&
          question_type === "objective" &&
          objectiveQ?.length === 0 && (
            <div className={styles.placeholder_container}>
              <HiOutlineDocumentPlus className={styles.icon} />
              <p className='fs-1 fw-bold mt-3'>Create Objective Exercise</p>
            </div>
          )}
        {!allLoading &&
          theoryQ?.length === 0 &&
          ...
          question_type === "" && (
            <div className={styles.placeholder_container}>
              <HiOutlineDocumentPlus className={styles.icon} />
              <p className='fs-1 fw-bold mt-3'>Create Exercise</p>
            </div>
          )}
