...
const PreSchoolInitialBroadSheet = () => {
  ...
  // console.log({ result, preActivities, academicDate });
  ...
  return (
    <div className='results-sheet'>
      ...
      <PageSheet>
        ...
        >
          <ResultHeader user={user} studentImage={studentData?.image} />
...
export default PreSchoolInitialBroadSheet;
